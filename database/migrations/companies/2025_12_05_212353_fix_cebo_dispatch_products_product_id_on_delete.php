...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        foreach ($foreignKeys as $fk) {
            try {
                \DB::statement("ALTER TABLE cebo_dispatch_products DROP FOREIGN KEY `{$fk->CONSTRAINT_NAME}`");
            } catch (\Exception $e) {
        ...
        Schema::table('cebo_dispatch_products', function (Blueprint $table) {
            // product_id: cambiar de cascade a restrict (no eliminar productos que están en despachos)
