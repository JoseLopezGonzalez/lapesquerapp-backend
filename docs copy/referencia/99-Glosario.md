...
**Referencia**: [Fundamentos - Introducción](../fundamentos/00-Introduccion.md)
...
**Referencia**: [Fundamentos - Arquitectura Multi-Tenant](../fundamentos/01-Arquitectura-Multi-Tenant.md)
...
**Referencia**: [Fundamentos - Autenticación](../fundamentos/02-Autenticacion-Autorizacion.md)
...
**Referencia**: [Producción - Lotes](../produccion/11-Produccion-Lotes.md)
...
**Referencia**: [Producción - Procesos](../produccion/12-Produccion-Procesos.md)
...
**Referencia**: [Producción - Entradas](../produccion/13-Produccion-Entradas.md)
...
**Referencia**: [Producción - Salidas](../produccion/14-Produccion-Salidas.md)
...
**Referencia**: [Pedidos - General](../pedidos/20-Pedidos-General.md)
...
**Referencia**: [Pedidos - Detalles Planificados](../pedidos/21-Pedidos-Detalles-Planificados.md)
...
**Referencia**: [Pedidos - Incidentes](../pedidos/23-Pedidos-Incidentes.md)

### Almacén (Store)
Ubicación física donde se almacenan productos. Puede tener capacidad, temperatura controlada, y mapa de posiciones.

**Referencia**: [Inventario - Almacenes](../inventario/30-Almacenes.md)
...
**Referencia**: [Catálogos - Incoterms](../catalogos/50-Incoterms.md)

### Código A3ERP
Código utilizado para integración con el sistema ERP A3. Almacenado en productos y clientes.

**Referencia**: [Catálogos - Productos](../catalogos/40-Productos.md), [Catálogos - Clientes](../catalogos/44-Clientes.md)
...
**Referencia**: [Catálogos - Productos](../catalogos/40-Productos.md)
...
**Referencia**: [Catálogos - Categorías y Familias](../catalogos/41-Categorias-Familias-Productos.md)
...
**Referencia**: [Sistema - Roles](../sistema/81-Roles.md)
...
**Referencia**: [Utilidades - Exportación Excel](../utilidades/91-Exportacion-Excel.md)
...
**Referencia**: [Utilidades - Extracción AI](../utilidades/92-Extraccion-Documentos-AI.md)
...
**Referencia**: [Utilidades - Generación PDF](../utilidades/90-Generacion-PDF.md)
...
**Referencia**: [Pedidos - Estadísticas](../pedidos/24-Pedidos-Estadisticas.md)

### Estadísticas de Stock
Métricas sobre inventario: totales de peso, palets, cajas, agrupado por especies, productos, almacenes.

**Referencia**: [Inventario - Estadísticas Stock](../inventario/33-Estadisticas-Stock.md)
...
**Referencia**: [Pedidos - Documentos](../pedidos/22-Pedidos-Documentos.md), [Utilidades - Exportación Excel](../utilidades/91-Exportacion-Excel.md)
...
**Referencia**: [Sistema - Sesiones](../sistema/82-Sesiones.md)

### Activity Log
Registro de actividades del usuario: acciones realizadas, IP, dispositivo, navegador, ruta accedida.

**Referencia**: [Sistema - Logs de Actividad](../sistema/83-Logs-Actividad.md)
...
**Referencia**: [Sistema - Configuración](../sistema/84-Configuracion.md)
...
- **Arquitectura**: [Fundamentos](../fundamentos/)
