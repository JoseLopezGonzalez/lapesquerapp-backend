...
- **Backend roles:** `docs/sistema/81-Roles.md`, `docs/sistema/80-Usuarios.md`.
- **API:** `docs/API-references/sistema/README.md`, `docs/API-references/autenticacion/README.md`.
- **Plan migración enum (ya ejecutado):** `docs/sistema/81-Roles-Plan-Migracion-Enum.md`.
