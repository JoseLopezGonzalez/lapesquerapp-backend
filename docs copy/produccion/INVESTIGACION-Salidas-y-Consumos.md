...
- `docs/produccion/13-Produccion-Entradas.md` - Documentación de inputs
- `docs/produccion/14-Produccion-Salidas.md` - Documentación de outputs
- `docs/produccion/15-Produccion-Consumos-Outputs-Padre.md` - Documentación de consumos
