...
**Base de la Documentación:** `/docs/31-api-references/`
...
**API Documenta:** ❌ Estos endpoints NO aparecen en `/docs/31-api-references/pedidos/README.md`
...
- Documentación API: `/docs/31-api-references/`
