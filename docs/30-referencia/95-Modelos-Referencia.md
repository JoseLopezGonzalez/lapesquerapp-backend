...
**Documentación Completa**: [Sistema - Usuarios](../28-sistema/80-Usuarios.md)
...
Los roles están fijados en código (enum). No existe modelo `Role` ni tabla `roles`. Valores: `tecnico`, `administrador`, `direccion`, `administracion`, `comercial`, `operario`. Ver [Sistema - Roles](../28-sistema/81-Roles.md).

**Documentación Completa**: [Sistema - Roles](../28-sistema/81-Roles.md)
...
**Documentación Completa**: [Fundamentos - Arquitectura Multi-Tenant](../20-fundamentos/01-Arquitectura-Multi-Tenant.md)
...
**Documentación Completa**: [Sistema - Logs de Actividad](../28-sistema/83-Logs-Actividad.md)
...
**Documentación Completa**: [Producción - Lotes](../25-produccion/11-Produccion-Lotes.md)
...
**Documentación Completa**: [Producción - Procesos](../25-produccion/12-Produccion-Procesos.md)
...
**Documentación Completa**: [Producción - Entradas](../25-produccion/13-Produccion-Entradas.md)
...
**Documentación Completa**: [Producción - Salidas](../25-produccion/14-Produccion-Salidas.md)
...
**Documentación Completa**: [Pedidos - General](../22-pedidos/20-Pedidos-General.md)
...
**Documentación Completa**: [Pedidos - Detalles Planificados](../22-pedidos/21-Pedidos-Detalles-Planificados.md)
...
**Documentación Completa**: [Pedidos - Incidentes](../22-pedidos/23-Pedidos-Incidentes.md)
...
**Documentación Completa**: [Inventario - Almacenes](../23-inventario/30-Almacenes.md)
...
**Documentación Completa**: [Inventario - Palets](../23-inventario/31-Palets.md)
...
**Documentación Completa**: [Inventario - Cajas](../23-inventario/32-Cajas.md)
...
**Documentación Completa**: [Catálogos - Productos](../24-catalogos/40-Productos.md)
...
**Documentación Completa**: [Catálogos - Categorías y Familias](../24-catalogos/41-Categorias-Familias-Productos.md)
...
**Documentación Completa**: [Catálogos - Especies](../24-catalogos/42-Especies.md)
...
**Documentación Completa**: [Catálogos - Zonas de Captura](../24-catalogos/43-Zonas-Captura.md)
...
**Documentación Completa**: [Catálogos - Clientes](../24-catalogos/44-Clientes.md)
...
**Documentación Completa**: [Catálogos - Proveedores](../24-catalogos/45-Proveedores.md)
...
**Documentación Completa**: [Catálogos - Transportes](../24-catalogos/46-Transportes.md)
...
**Documentación Completa**: [Catálogos - Vendedores](../24-catalogos/47-Vendedores.md)
...
**Documentación Completa**: [Catálogos - Términos de Pago](../24-catalogos/48-Terminos-Pago.md)
...
**Documentación Completa**: [Catálogos - Países](../24-catalogos/49-Paises.md)
...
**Documentación Completa**: [Catálogos - Incoterms](../24-catalogos/50-Incoterms.md)
...
**Documentación Completa**: [Catálogos - Arte Pesquera](../24-catalogos/51-Arte-Pesquera.md)
...
**Documentación Completa**: [Catálogos - Impuestos](../24-catalogos/52-Impuestos.md)
...
**Documentación Completa**: [Catálogos - Procesos](../24-catalogos/53-Procesos.md)
...
**Documentación Completa**: [Recepciones - Materia Prima](../26-recepciones-despachos/60-Recepciones-Materia-Prima.md)
...
**Documentación Completa**: [Despachos - Cebo](../26-recepciones-despachos/61-Despachos-Cebo.md)
...
**Documentación Completa**: [Etiquetas](../27-etiquetas/70-Etiquetas.md)
...
2. **Relaciones 1:1 con ID Compartido**: `Product` y `Article` comparten el mismo `id`. Esta es una relación especial documentada en [Catálogos - Productos](../24-catalogos/40-Productos.md).
...
- **Fundamentos**: [Arquitectura Multi-Tenant](../20-fundamentos/01-Arquitectura-Multi-Tenant.md)
- **Producción**: [Producción - General](../25-produccion/10-Produccion-General.md)
- **Pedidos**: [Pedidos - General](../22-pedidos/20-Pedidos-General.md)
- **Inventario**: [Inventario - General](../23-inventario/30-Almacenes.md)
- **Catálogos**: [Catálogos - Productos](../24-catalogos/40-Productos.md)
- **Sistema**: [Sistema - Usuarios](../28-sistema/80-Usuarios.md)
