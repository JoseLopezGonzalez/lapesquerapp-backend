...
- [24-Pedidos-Estadisticas.md](../22-pedidos/24-Pedidos-Estadisticas.md) — Parámetros de estadísticas de pedidos.
- [33-Estadisticas-Stock.md](../23-inventario/33-Estadisticas-Stock.md) — Estadísticas de stock.
- [90-Generacion-PDF.md](../29-utilidades/90-Generacion-PDF.md) — Generación de PDFs.
- [91-Exportacion-Excel.md](../29-utilidades/91-Exportacion-Excel.md) — Exportación Excel.
