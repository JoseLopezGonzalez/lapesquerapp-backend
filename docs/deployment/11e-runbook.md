...
- Ver [instrucciones/CORS-GUIA-DEFINITIVA.md](../instrucciones/CORS-GUIA-DEFINITIVA.md) (o documentación CORS consolidada) para diagnóstico y configuración de `Allow-Origin` y headers.
