...
2. **📊 [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json)**
   - Ejemplo JSON completo
   - Listo para usar en desarrollo
   - Incluye todos los tipos de nodos

3. **📖 [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v4.md`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v4.md)**
...
### Ejemplos JSON
- [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v3.json`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v3.json) (versión anterior)
- [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json) (versión actual)
