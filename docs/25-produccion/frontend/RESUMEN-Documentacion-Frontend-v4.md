...
**[`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json)**
...
**[`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v4.md`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v4.md)**
...
2. **Luego**: [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v4.md`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v4.md) (explicación del ejemplo)
3. **Después**: Ver el JSON: [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v4-completo.json)
