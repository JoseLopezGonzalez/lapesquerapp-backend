...
- [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v3.json`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v3.json) - Ejemplo JSON completo ✅
- [`../../ejemplos/EJEMPLO-RESPUESTA-process-tree-v3.md`](../../32-ejemplos/EJEMPLO-RESPUESTA-process-tree-v3.md) - Explicación del ejemplo ✅
