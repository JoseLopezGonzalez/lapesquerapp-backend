...
- `tenants:migrate` — Migraciones por tenant (`--fresh`, `--seed`). Ver [database.md](./database.md) y [deployment/11c-PRODUCTION.md](./deployment/11c-PRODUCTION.md).

---

## Véase también

- [queues-jobs.md](./queues-jobs.md) — Colas (algunos jobs pueden ser disparados por el scheduler).
- [deployment/11c-PRODUCTION.md](./deployment/11c-PRODUCTION.md) — Producción (cron y comprobaciones).
- [deployment/11e-RUNBOOK.md](./deployment/11e-RUNBOOK.md) — Runbook operativo.
