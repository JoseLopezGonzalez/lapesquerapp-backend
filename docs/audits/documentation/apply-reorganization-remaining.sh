...
[ -f docs/fundamentos/02-Convencion-Tenant-Jobs.md ] && mv docs/fundamentos/02-Convencion-Tenant-Jobs.md docs/fundamentos/02b-Convencion-Tenant-Jobs.md && echo "  Renamed 02-Convencion -> 02b"
[ -f docs/inventario/31-Palets-Estados-Fijos.md ] && mv docs/inventario/31-Palets-Estados-Fijos.md docs/inventario/31b-Palets-Estados-Fijos.md && echo "  Renamed 31-Palets-Estados -> 31b"
[ -f docs/sistema/82-Roles-Pasos-2-y-3-Pendientes.md ] && mv docs/sistema/82-Roles-Pasos-2-y-3-Pendientes.md docs/sistema/82b-Roles-Pasos-Pendientes.md && echo "  Renamed 82-Roles-Pasos -> 82b"

echo "=== FASE 5: Mover documentos ==="
[ -f docs/sistema/86-Control-Horario-FRONTEND.md ] && mv docs/sistema/86-Control-Horario-FRONTEND.md docs/frontend/Control-Horario-FRONTEND.md && echo "  Moved 86-Control-Horario-FRONTEND -> frontend"
...
if [ -f docs/PROBLEMAS-CRITICOS.md ]; then
  ...
  sed -i 's|../PROBLEMAS-CRITICOS\.md|../audits/PROBLEMAS-CRITICOS.md|g' docs/por-hacer/ROADMAP.md docs/por-hacer/TECH_DEBT.md 2>/dev/null || true
fi
