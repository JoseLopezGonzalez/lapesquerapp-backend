...
|---------|-----------------|------------|
| docs/README.md | `./instrucciones/deploy-desarrollo.md` | `./instrucciones/_archivo/deploy-desarrollo.md` (y nota "archivado; canónico: deploy-desarrollo-guiado") |
| docs/instrucciones/deploy-desarrollo-guiado.md | `./deploy-desarrollo.md` (al final) | `_archivo/deploy-desarrollo.md` |
...
- **Laravel 11:** Corregido en `docs/fundamentos/00-Introduccion.md` y `docs/utilidades/93-Plan-Integracion-Tesseract-OCR.md`. README ya estaba en Laravel 10. ✅
...
- "Por completar" / "TODO": varios documentos (ROADMAP, TECH_DEBT, overview en algunas celdas) los tienen de forma explícita; se consideran stubs conocidos. No se ha generado lista exhaustiva; queda para FASE B si se desea priorizar.
...
- **00_ POR IMPLEMENTAR:** Carpeta eliminada. Contenido unificado en **`por-hacer/`** (incl. ex por-implementar). ✅
...
**Próximo:** FASE B (documentación desactualizada) o F.1 (decisiones prompts, etc.) según PLAN-PENDIENTES-DOCUMENTACION.md.
