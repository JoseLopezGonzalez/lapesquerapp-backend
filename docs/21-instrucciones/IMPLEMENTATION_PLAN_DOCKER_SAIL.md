...
Generar **FASE 2:** `docs/21-instrucciones/EXECUTION_CHECKLIST.md` con checklist por bloques (Docker/Sail, .env, Seeders, Integración frontend, Validación final) y solo entonces ejecutar cambios en **FASE 3** por bloques verificables.
