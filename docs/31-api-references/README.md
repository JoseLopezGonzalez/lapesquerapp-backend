...
- **[Pedidos](./22-pedidos/README.md)** - Gestión de pedidos, detalles planificados, incidentes
- **[Productos](./productos/README.md)** - Productos, categorías, familias
- **[Inventario](./23-inventario/README.md)** - Almacenes, palets, cajas
- **[Producción](./25-produccion/README.md)** - Lotes, registros, entradas y salidas
- **[Catálogos](./24-catalogos/README.md)** - Clientes, proveedores, especies, transportes, etc.
- **[Estadísticas](./estadisticas/README.md)** - Estadísticas y reportes
- **[Utilidades](./29-utilidades/README.md)** - Generación de PDFs y exportación Excel
- **[Sistema](./28-sistema/README.md)** - Usuarios, roles, logs de actividad
- **[Recepciones y Despachos](./26-recepciones-despachos/README.md)** - Recepciones de materia prima, despachos de cebo, liquidaciones
...
- [Rutas Completas](../30-referencia/97-Rutas-Completas.md) - Listado completo de todas las rutas
- [Fundamentos](../20-fundamentos/README.md) - Conceptos básicos de la API
- [Autenticación y Autorización](../20-fundamentos/02-Autenticacion-Autorizacion.md) - Guía detallada de autenticación
