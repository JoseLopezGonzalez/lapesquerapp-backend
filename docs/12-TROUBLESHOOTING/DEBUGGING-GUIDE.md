...
- Ver [../21-instrucciones/CORS-GUIA-DEFINITIVA.md](../21-instrucciones/CORS-GUIA-DEFINITIVA.md). Comprobar con `curl -H "Origin: ..."` que el servidor devuelve `Access-Control-Allow-Origin`; si no, proxy o Laravel no reciben `Origin`.
...
- [../11-DEPLOYMENT/11e-RUNBOOK.md](../11-DEPLOYMENT/11e-RUNBOOK.md) — Runbook (logs, incidentes).
