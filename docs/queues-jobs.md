...
- [environment-variables.md](./environment-variables.md) — Variables (QUEUE_CONNECTION, Redis).
- [scheduler-cron.md](./scheduler-cron.md) — Scheduler (algunos comandos pueden despachar jobs).
- [deployment/11c-PRODUCTION.md](./deployment/11c-PRODUCTION.md) — Producción (workers y reinicio).
