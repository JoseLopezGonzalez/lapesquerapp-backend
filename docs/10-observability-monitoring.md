...
- **Runbook:** Procedimientos operativos detallados (reinicio, escalado, respuesta a incidentes) en [deployment/11e-RUNBOOK.md](./deployment/11e-RUNBOOK.md).
...
- [troubleshooting/PERFORMANCE-ISSUES.md](./troubleshooting/PERFORMANCE-ISSUES.md) — Problemas de rendimiento.
