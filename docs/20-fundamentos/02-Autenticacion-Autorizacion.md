...
**Documentación detallada de auth:** ver `docs/33-frontend/Guia-Frontend-Actualizaciones-Auth-y-Usuarios.md` y `docs/28-sistema/89-Auth-Contrasenas-Eliminadas.md`.
