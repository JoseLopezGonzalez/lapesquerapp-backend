# Cursor Agent Prompt — Limpieza REAL de /docs (orden invertido) — Laravel

Eres un Staff/Principal Engineer experto en Laravel y documentación técnica. Tu misión es **arreglar /docs de verdad**, pero con este orden obligatorio:
...
- `/docs/_worklog/VERIFY.md`
  (si algo queda como “no verificable”, anótalo aquí con lo que faltó para verificar)
...
- Pregunta SOLO si hay una duda crítica que impida validar (ej: si el deploy real es Coolify vs algo distinto y el repo no lo deja claro).
