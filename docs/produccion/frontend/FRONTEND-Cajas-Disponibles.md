...
- Documentación de Cajas: `docs/inventario/32-Cajas.md`
- Documentación de Palets: `docs/inventario/31-Palets.md`
- Documentación de Producción Entradas: `docs/produccion/13-Produccion-Entradas.md`
