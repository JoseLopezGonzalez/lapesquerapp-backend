...
return [
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'GET /api/health',
                // 'api/debug/*', 'api/internal/*' when present
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtén tu token mediante el endpoint de login. Incluye el token en el header Authorization con el prefijo "Bearer ".',
    ],
    ...
    'openapi' => [
        ...
        'overrides' => [
            ...
            'info.contact' => [
                ...
                'email' => env('SUPPORT_EMAIL', 'support@pesquerapp.com'),
            ],
        ],
