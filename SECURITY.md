...
- Variables críticas típicas: `APP_KEY`, `DB_*`, `REDIS_*`, claves de servicios externos (mail, Azure Document AI, etc.). Documentación de variables: [docs/environment-variables.md](docs/environment-variables.md) y [docs/fundamentos/03-Configuracion-Entorno.md](docs/fundamentos/03-Configuracion-Entorno.md).
...
- [docs/environment-variables.md](docs/environment-variables.md) — Variables de entorno.
- [docs/multi-tenant-specs.md](docs/multi-tenant-specs.md) — Multi-tenant y seguridad de datos.
- [docs/api-rest.md](docs/api-rest.md) — API y autenticación de requests.
- [docs/deployment/11c-PRODUCTION.md](docs/deployment/11c-PRODUCTION.md) — Despliegue en producción (configuración segura).
