...
class AuthServiceProvider extends ServiceProvider
{
    ...
    protected $policies = [
        ...
        \App\Models\ExternalUser::class => \App\Policies\ExternalUserPolicy::class,
        \App\Models\ExternalProcessor::class => \App\Policies\ExternalProcessorPolicy::class,
        \App\Models\Customer::class => \App\Policies\CustomerPolicy::class,
        \App\Models\FieldOperator::class => \App\Policies\FieldOperatorPolicy::class,
        \App\Models\Salesperson::class => \App\Policies\SalespersonPolicy::class,
        \App\Models\RouteTemplate::class => \App\Policies\RouteTemplatePolicy::class,
        \App\Models\DeliveryRoute::class => \App\Policies\DeliveryRoutePolicy::class,
        ...
        \App\Models\ProspectCategory::class => \App\Policies\ProspectCategoryPolicy::class,
        ...
        \App\Models\CustomsBroker::class => \App\Policies\CustomsBrokerPolicy::class,
    ];
