...
class ProductionOutput extends Model
{
    ...
    {
        return app(ProductionCostResolver::class)->getOutputCostPerKg($this);
    }
    ...
    {
        return app(ProductionCostResolver::class)->getOutputTotalCost($this);
    }
    ...
    {
        return app(ProductionCostResolver::class)->getOutputCostBreakdown($this);
    }
}
