...
use App\Http\Requests\v2\IndexProductionRecordRequest;
use App\Http\Requests\v2\ProductionRecordOptionsRequest;
...
class ProductionRecordController extends Controller
{
     ...
     */
    public function index(IndexProductionRecordRequest $request)
    {
    ...
    public function show(string $id)
    {
        $record = ProductionRecord::with([
            ...
            'process',
            'inputs.box.product',
            'inputs.box.palletBox.pallet.reception.products',
     ...
     */
    public function options(ProductionRecordOptionsRequest $request)
    {
     ...
     * (inputs de stock, consumos del padre, totales).
     */
    public function getSourcesData(string $id): JsonResponse
    {
        ...
        $data = $this->productionRecordService->getSourcesData($record);
