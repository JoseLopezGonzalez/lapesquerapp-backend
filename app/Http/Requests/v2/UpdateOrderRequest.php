...
class UpdateOrderRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'externalProcessor.integer' => 'El transformador externo debe ser un número entero.',
            'externalProcessor.exists' => 'El transformador externo seleccionado no existe.',
            ...
            'invoiced.boolean' => 'El campo facturado debe ser verdadero o falso.',
